...
<body>
    <div class="p-3 d-flex justify-content-center bg-secondary">
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST" id="search">
            <div class=row>
                <div class=col-md>
                    <select name="make" id="make" class="form-select form-select-sm" aria-label=".form-select-sm example">
                ...
                <div class=col-md>
                    <select name="class" id="class" class="form-select form-select-sm" aria-label=".form-select-sm example">
            ...
            <div class=row>
                ...
                <div class=col-sm>
                    ...
                    <label for="price" class="form-check-label text-light">Price</label>
                </div>
                <div class=col-sm>
                    <input type="radio" id="year" name="sort" value="year" class="form-check-input ">
                    <label for="year" class="form-check-label text-light">Year</label>
                </div>
            </div>
